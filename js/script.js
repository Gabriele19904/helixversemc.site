...
const config = {
    serverInfo: {
        ...
        serverName: "HelixVerseMC", /*Server name*/
        serverIp: "helixversemc.it", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1381285227082813522" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    */
    ...
    adminTeamPage: {
        Founder: [
            {
                inGameName: "GabryBuilder",
                rank: "Founder",
                skinUrlOrPathToFile: "https://s.namemc.com/3d/skin/body.png?id=ae1043ebd5ce0539&model=slim&theta=30&phi=21&time=1364.76&width=600&height=800",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "Dark_Angel19004",
                rank: "Founder",
                skinUrlOrPathToFile: "https://s.namemc.com/3d/skin/body.png?id=a763c8d4fe45c358&model=classic&theta=30&phi=21&time=90&width=600&height=800",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "Ema",
                rank: "Founder",
                skinUrlOrPathToFile: "https://s.namemc.com/3d/skin/body.png?id=f494420878d94748&model=classic&theta=30&phi=21&time=90&width=600&height=800",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "Soon",
